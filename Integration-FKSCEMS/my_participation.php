...
<?php endwhile; ?>
            ...
            <?php if ($history_total_pages > 1) : ?>
                <div class="pagination">
                    <?php
                    $previous_params = ['history_page' => max(1, $history_page - 1)];
                    $next_params = ['history_page' => min($history_total_pages, $history_page + 1)];
                    ?>
                    <a class="pagination-link <?php echo $history_page <= 1 ? 'disabled' : ''; ?>" href="my_participation.php?<?php echo h(http_build_query($previous_params)); ?>">Previous</a>
                    <span class="pagination-status">Page <?php echo $history_page; ?> of <?php echo $history_total_pages; ?></span>
                    <a class="pagination-link <?php echo $history_page >= $history_total_pages ? 'disabled' : ''; ?>" href="my_participation.php?<?php echo h(http_build_query($next_params)); ?>">Next</a>
                </div>
            <?php endif; ?>
