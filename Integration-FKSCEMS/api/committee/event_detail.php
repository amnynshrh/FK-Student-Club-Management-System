...
$loggedInViaApi = isset($_SESSION["Login"]) && $_SESSION["Login"] === "YES"
    && strtolower($_SESSION["role"] ?? "") === "committee";
$loggedInViaLegacy = !empty($_SESSION["SESS_USER_ID"])
    && strtolower($_SESSION["SESS_ROLE"] ?? "") === "committee";

if (!$loggedInViaApi && !$loggedInViaLegacy) {
    echo json_encode([
        "success" => false,
