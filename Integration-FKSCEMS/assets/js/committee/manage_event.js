    ...
    row.innerHTML = `
      ...
      <td>
        <div class="action-buttons">
          ...
          <a href="view_event.php?id=${event.id}" class="action-btn view-btn text-decoration-none">
            <i class="bi bi-eye"></i>
          </a>

          <a href="edit_event.php?id=${event.id}" class="action-btn edit-btn text-decoration-none">
