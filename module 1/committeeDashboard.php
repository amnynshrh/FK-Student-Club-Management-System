...
// Using SESS_USER_ID and SESS_ROLE to match your authentication logic
if (!isset($_SESSION['SESS_ROLE']) || $_SESSION['SESS_ROLE'] !== 'Committee') {
...
<nav class="top-navigation">
    <div class="nav-wrapper">
        ...
        <ul class="menu-links">
            <li><a href="committeeDashboard.php" class="active">Management</a></li>
        ...
        <div class="admin-profile">
            <span>Committee: <?php echo htmlspecialchars($user_data['name'] ?? 'User'); ?></span>
        </div>
    </div>
</nav>
