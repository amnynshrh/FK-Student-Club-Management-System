...
<nav class="top-navigation">
    <div class="nav-wrapper">
        ...
        <ul class="menu-links">
            <li><a href="studentDashboard.php" class="active">My Dashboard</a></li>
            <li><a href="#">Explore Clubs</a></li>
            <li><a href="#">My Activities</a></li>
            <li><a href="editprofile.php">Profile</a></li>
            <li><a href="logout.php" style="color: #dc3545; font-weight: bold;">Logout</a></li>
        </ul>
        <div class="admin-profile">
            <span>Welcome, <?php echo htmlspecialchars($user_data['name'] ?? 'User'); ?></span>
        </div>
    </div>
</nav>
